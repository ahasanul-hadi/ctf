...
public class ScoreBoardService {
    ...
    */
    ...
    public List<IncrementalScore> getIncrementalScore(List<SubmissionEntity> submissions){
        ...
        List<SubmissionEntity> orderSubmissions= new ArrayList<>(submissions).stream().filter(SubmissionEntity::isPublished).sorted(Comparator.comparing(SubmissionEntity::getSubmissionTime)).toList();
        int gradualScore=0;
